                                         ...
                                         char* precio, char* cuit)
{
    ...
    {
        if (entidad_setIdStr(pEntidad, id) && entidad_setFecha(pEntidad, fecha) &&
            entidad_setFoto(pEntidad, foto) && entidad_setCantidadStr(pEntidad, cantidad) &&
            entidad_setPrecioStr(pEntidad, precio) && entidad_setCuit(pEntidad, cuit))
        {
